...
public class EditarPersonaController implements Initializable {
    ...
    public void setPersona(Persona persona) {
        ...
        fechaDeNacimientoTextField.setText(UtilidadDeFecha.formato(persona.getFechaDeNacimiento()));
    ...
    private void guardar() {
        ...
        if (datosValidos()) {
            ...
            persona.setFechaDeNacimiento(UtilidadDeFecha.convertir(fechaDeNacimientoTextField.getText()));
    ...
    private boolean datosValidos(){
        ...
        if (fechaDeNacimientoTextField.getText() == null || fechaDeNacimientoTextField.getText().length() == 0) {
            ...
            if (!UtilidadDeFecha.fechaValida(fechaDeNacimientoTextField.getText())) {
